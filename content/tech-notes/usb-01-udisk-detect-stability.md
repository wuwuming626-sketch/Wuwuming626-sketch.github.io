...
我这边理的是 USB Host 侧的插拔稳定性：U 盘检测、消抖、挂载升级，还有 USB 虚拟串口。覆盖 BK7258 + CherryUSB/MUSB 上的 MB12、I12，以及 RK3506/RK3576 上的 V67 和 A330。问题集中在 T134088 这类「待机下多次插拔就异常」的场景。下面把整条链路和踩过的坑记一遍。
